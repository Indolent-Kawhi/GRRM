...
def compute_advantage(
    ...
    elif adv_estimator == AdvantageEstimator.PASSK:
        # Initialize the mask for PASSK calculation
        passk_calculation_mask = data.batch["response_mask"]
        # Call compute_passk_outcome_advantage with parameters matching its definition
        advantages, returns = core_algos.compute_passk_outcome_advantage(
            token_level_rewards=data.batch["token_level_rewards"],
            response_mask=passk_calculation_mask,
