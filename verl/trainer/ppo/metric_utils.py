...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    match = batch.non_tensor_batch["match"]
    # consistency = batch.non_tensor_batch["consistency"]
    ...
    metrics = {
        ...
        # format
        "critic/format/mean": np.mean(format),

        # consistency
        # "critic/consistency/mean": np.mean(consistency),
        
        # match
        "critic/match/mean": np.mean(match),
